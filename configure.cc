...
int main() {
  ...
  n.CompileLink("ninjafs", {"basename",
			    "directory_container",
			    "get_current_dir",
			    "ninjafs",
			    "strutil"});
  ...
  n.CompileLinkRunTest("git-githubfs_test", {"base64decode",
					     "basename",
					     "cached_file",
					     "concurrency_limit",
					     "directory_container",
					     ...
					     "stats_holder",
					     "strutil"});
  n.CompileLink("git-githubfs", {"base64decode",
				 "basename",
				 "cached_file",
				 "concurrency_limit",
				 "directory_container",
				 ...
				 "stats_holder",
				 "strutil"});
  n.CompileLinkRunTest("concurrency_limit_test", {"concurrency_limit_test",
						  "concurrency_limit"});
  n.CompileLinkRunTest("directory_container_test", {"directory_container",
  ...
  n.CompileLinkRunTest("cached_file_test", {"cached_file",
					    "cached_file_test",
					    "stats_holder"});
  n.CompileLink("cached_file_util", {"cached_file",
				     "cached_file_util",
				     "stats_holder",});
  n.CompileLinkRunTest("base64decode_test", {"base64decode",
					     "base64decode_test"});
  n.CompileLinkRunTest("base64decode_benchmark", {"base64decode",
  ...
  n.CompileLink("experimental/gitfs",
		{"experimental/gitfs",
		 ...
		 "get_current_dir",
		 "experimental/gitxx",
		 "basename"}).Cclink("cclinkwithgit2");
  n.CompileLinkRunTest("experimental/gitfs_test",
		       {"experimental/gitfs",
			...
			"experimental/gitxx",
			"basename"},
		       {"out/fetch_test_repo.sh.result"}).Cclink("cclinkwithgit2");
  n.CompileLinkRunTest("experimental/libgit2test",
		       {"experimental/libgit2test", "experimental/gitxx"},
		       {"out/fetch_test_repo.sh.result"}).Cclink("cclinkwithgit2");
  n.CompileLink("experimental/hello_fuseflags", {"experimental/hello_fuseflags"});
  n.CompileLink("experimental/unkofs", {"experimental/unkofs",
					  "experimental/roptfs",
					  "relative_path",
					  "update_rlimit"
    });
  n.RunTestScript("experimental/unkofs_test.sh", {"out/experimental/unkofs"});
  n.CompileLink("experimental/globfs", {"experimental/globfs",
					"experimental/roptfs",
					"relative_path",
					"update_rlimit"
    });
  n.RunTestScript("experimental/globfs_test.sh", {"out/experimental/globfs"});
  n.CompileLink("cowfs", {"cowfs", "cowfs_crypt", "file_copy",
			  "ptfs", "ptfs_handler",
			  "relative_path", "scoped_fileutil", "strutil",
			  "update_rlimit"}).Cclink("cclinkcowfs");
  n.CompileLinkRunTest("cowfs_crypt_test", {"cowfs_crypt",
					    "cowfs_crypt_test"}).Cclink("cclinkcowfs");
  n.RunTestScript("cowfs_test.sh", {"out/cowfs", "out/hello_world"});
  n.CompileLink("ptfs", {"ptfs_main",
			 "ptfs",
			 "ptfs_handler",
			 "relative_path",
			 "scoped_fileutil",
  ...
  n.CompileLink("experimental/parallel_writer", {"experimental/parallel_writer"});
  n.CompileLinkRunTest("scoped_fileutil_test",
		       {"scoped_fileutil_test",
			"scoped_fileutil"});
  n.CompileLinkRunTest("jsonparser_test",
		       {"jsonparser_test",
			"jsonparser"});
  ...
  n.CompileLinkRunTest("scoped_timer_test",
			...
			"scoped_timer_test",
			"stats_holder"});
  n.CompileLinkRunTest("gitiles_test",
		       {"base64decode",
			"gitiles_test",
			"jsonparser",
			"strutil"});
